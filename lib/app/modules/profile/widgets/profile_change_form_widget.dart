...
class ProfileChangeFormWidget extends GetView<ProfileController> {
  final VoidCallback onSubmit;

  const ProfileChangeFormWidget({super.key, required this.onSubmit});
