...
class RiwayatCardItem extends GetView<RiwayatController> {
  const RiwayatCardItem({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final hiking = hikingService.allHikings.firstWhereOrNull(
        (h) => h.reservasiId == riwayat.reservasi.id,
      );
      ...
      final paymentTagColor = isPaid
          ? const Color(0xFFE1F6EB)
          : const Color(0xFFFFE4C7);
      final paymentTextColor = isPaid
          ? const Color(0xFF1B8E6A)
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          riwayat.reservasi.code.isNotEmpty
                              ? riwayat.reservasi.code
                              : '-',
...
class _Chip extends GetView<RiwayatController> {
